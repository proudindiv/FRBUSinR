...
raw6 = raw5[[1]]
raw7 = toupper(gsub(":.*$", "", raw6))
eqs = gsub("^.*:", "", raw6)
stdver = data.frame(eqs, row.names = raw7, stringsAsFactors = FALSE)
str(stdver)
stdver["CENG","eqs"]
stdver["PGDP","eqs"]
@
